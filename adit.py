...
call = aditmadzs
creator = ["u2fdd3f62f08f6786746dd3cb4b11e198"]
owner = ["u2fdd3f62f08f6786746dd3cb4b11e198"]
admin = ["u2fdd3f62f08f6786746dd3cb4b11e198"]
staff = ["u2fdd3f62f08f6786746dd3cb4b11e198"]
                 ...
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        aditmadzs.sendMessage(msg.to,"Contact itu already To member bot")
                        wait["addbots"] = True
                    else:
                        Bots.append(msg.contentMetadata["mid"])
                        wait["addbots"] = True
                        aditmadzs.sendMessage(msg.to,"Succeeded Add ke member bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["mid"])
                        aditmadzs.sendMessage(msg.to,"Succeeded remove From member bot")
                    else:
                        wait["dellbots"] = True
                        aditmadzs.sendMessage(msg.to,"Contact itu bukan member Aditmadzs BOT")
#===========ADD STAFF============#
                 if msg._from in admin:
                  if wait["addstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        aditmadzs.sendMessage(msg.to,"Contact itu already To staff")
                        wait["addstaff"] = True
                    else:
                        staff.append(msg.contentMetadata["mid"])
                        wait["addstaff"] = True
                        aditmadzs.sendMessage(msg.to,"Succeeded Add ke staff")
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        staff.remove(msg.contentMetadata["mid"])
                        aditmadzs.sendMessage(msg.to,"Succeeded remove From staff")
                        wait["dellstaff"] = True
                    else:
                        wait["dellstaff"] = True
                 ...
                 if msg._from in admin:
                  if wait["addadmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        aditmadzs.sendMessage(msg.to,"Contact itu already To admin")
                        wait["addadmin"] = True
                    else:
                        admin.append(msg.contentMetadata["mid"])
                        wait["addadmin"] = True
                        aditmadzs.sendMessage(msg.to,"Succeeded Add ke admin")
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        admin.remove(msg.contentMetadata["mid"])
                        aditmadzs.sendMessage(msg.to,"Succeeded remove From admin")
                    else:
                        wait["delladmin"] = True
                 ...
                 if msg._from in admin:
                  if wait["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        aditmadzs.sendMessage(msg.to,"Contact itu already ada di blacklist")
                        wait["wblacklist"] = True
                    else:
                        wait["blacklist"][msg.contentMetadata["mid"]] = True
                        wait["wblacklist"] = True
                        aditmadzs.sendMessage(msg.to,"Succeeded Add ke blacklist user")
                  if wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        aditmadzs.sendMessage(msg.to,"Succeeded remove From blacklist user")
                    else:
                        wait["dblacklist"] = True
                        aditmadzs.sendMessage(msg.to,"Contact itu Not ada di blacklist")
#===========TALKBAN============#
                 if msg._from in admin:
                  if wait["Talkwblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        aditmadzs.sendMessage(msg.to,"Contact itu already ada di Talkban")
                        wait["Talkwblacklist"] = True
                    else:
                        wait["Talkblacklist"][msg.contentMetadata["mid"]] = True
                        wait["Talkwblacklist"] = True
                        aditmadzs.sendMessage(msg.to,"Succeeded Add ke Talkban user")
                  if wait["Talkdblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        del wait["Talkblacklist"][msg.contentMetadata["mid"]]
                        aditmadzs.sendMessage(msg.to,"Succeeded remove From Talkban user")
                    else:
                        wait["Talkdblacklist"] = True
                        aditmadzs.sendMessage(msg.to,"Contact itu Not ada di Talkban")
#===========UPDATE FOTO============#
               if msg.contentType == 1:
                 if msg._from in admin:
                    if Setmain["Addimage"] == True:
                        ...
                        if r.status_code == 200:
                            ...
                            aditmadzs.sendMessage(msg.to, "Succeeded Add gambar")
                        Setmain["Img"] = {}
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     aditmadzs.sendMessage(msg.to, "Succeeded mengubah foto group")
               ...
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ADITMADZSfoto"]:
                            ...
                            aditmadzs.sendMessage(msg.to,"Foto Succeeded dirubah")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                aditmadzs.sendMessage(msg.to, "Selfbot activated")

                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                aditmadzs.sendMessage(msg.to, "Selfbot deactivated")
                        ...
                        if cmd == "unsend on":
                            if msg._from in admin:
                                wait["unsend"] = True
                                aditmadzs.sendMessage(msg.to, "Detection Unsend activated")

                        if cmd == "unsend off":
                            if msg._from in admin:
                                wait["unsend"] = False
                                aditmadzs.sendMessage(msg.to, "Detection Unsend deactivated")
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ki.leaveGroup(i)
                                    aditmadzs.sendMessage(msg.to,"Succeeded keluar di grup " +str(ginfo.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  aditmadzs.sendMessage(to, "Succeeded tolak sebanyak {} undangan grup".format(str(len(ginvited))))
                              else:
                                  aditmadzs.sendMessage(to, "Not ada undangan yang tertunda")
...
#===========BOT UPDATE============#
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                aditmadzs.sendMessage(msg.to,"Nama replaced To " + string + "")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"⏩ BOT Protection\n\n⏩ PROTECT URL :\n"+ma+"\n⏩ PROTECT KICK :\n"+mb+"\n⏩ PROTECT JOIN :\n"+md+"\n⏩ PROTECT CANCEL:\n"+mc+"\n⏩ PROTECT INVITE :\n"+me+"\nTotal「%s」Protect yang Active" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel)+len(protectinvite))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    member = [Amid]
                                    aditmadzs.inviteIntoGroup(msg.to, member)
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ...
                                        ki.leaveGroup(i)
                                        aditmadzs.sendMessage(to,"Succeeded keluar From grup " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 aditmadzs.sendMessage(msg.to, "Lurking Succeeded activated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 aditmadzs.sendMessage(msg.to, "Lurking Succeeded dinoActivekan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  aditmadzs.sendMessage(msg.to, "Cek sider activated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  aditmadzs.sendMessage(msg.to, "Cek sider deactivated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
                                  aditmadzs.sendMessage(msg.to, "Sudak Not Active")
...
#=========== ͣ ͫ͢ŚhÀH•ŹÀ!η============#
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                lirik = k.replace("***Lirik didapat From pihak ketiga***\n","")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"Total Spamtag Changed To be " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                aditmadzs.sendMessage(msg.to,"Total Spamcall Changed To be " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                aditmadzs.sendMessage(msg.to, "Succeeded mengundang {} undangan Call Grup".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                                    ...
                                    aditmadzs.sendMessage(msg.to,"Total melebihi batas")
...
#===========Settings============#
                              ...
                              if spl == 'on':
                                  if msg.to in simisimi:
                                       msgs = "Simi-simi already Active"
                                  else:
                                       simisimi.append(msg.to)
                                       ginfo = ki.getGroup(msg.to)
                                       msgs = "Simi-simi activated\nIn Group : " +str(ginfo.name)
                                  ki.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in simisimi:
                                         simisimi.remove(msg.to)
                                         ginfo = ki.getGroup(msg.to)
                                         msgs = "Simi-simi deactivated\nIn Group : " +str(ginfo.name)
                                    else:
                                         msgs = "Simi-simi already Not Active"
                                    ki.sendMessage(msg.to, "「deactivated」\n" + msgs)

                        elif 'Autotrans th-' in msg.text:
                              spl = msg.text.replace('Autotrans th-','')
                              if spl == 'on':
                                  if msg.to in translateth:
                                       msgs = "Auto Translate already Active"
                                  else:
                                       translateth.append(msg.to)
                                       ginfo = ki.getGroup(msg.to)
                                       msgs = "Auto Translate activated\nIn Group : " +str(ginfo.name)
                                  ki.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in translateth:
                                         translateth.remove(msg.to)
                                         ginfo = ki.getGroup(msg.to)
                                         msgs = "Auto Translate deactivated\nIn Group : " +str(ginfo.name)
                                    else:
                                         msgs = "Auto Translate already Not Active"
                                    ki.sendMessage(msg.to, "「deactivated」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  aditmadzs.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in welcome:
                                    ...
                                    aditmadzs.sendMessage(msg.to, "「deactivated」\n" + msgs)
...
#===========Protection============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "All protection already on\nIn Group : " +str(ginfo.name)
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = aditmadzs.getGroup(msg.to)
                                      msgs = "Succeeded mengActivekan All protect\nIn Group : " +str(ginfo.name)
                                  aditmadzs.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    ...
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "Succeeded menonActivekan All protect\nIn Group : " +str(ginfo.name)
                                    else:
                                         ginfo = aditmadzs.getGroup(msg.to)
                                         msgs = "All protect already off\nIn Group : " +str(ginfo.name)
                                    aditmadzs.sendMessage(msg.to, "「deactivated」\n" + msgs)
                            ...
                            if msg._from in creator:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           aditmadzs.sendMessage(msg.to,"Succeeded Add admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           aditmadzs.sendMessage(msg.to,"Succeeded Add staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           aditmadzs.sendMessage(msg.to,"Succeeded Add bot")
                                       except:
                                           pass
                            ...
                            if msg._from in creator:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           f=codecs.open('admin.json','w','utf-8')
                                           json.dump(admin, f, sort_keys=True, indent=4,ensure_ascii=False)
                                           aditmadzs.sendMessage(msg.to,"Succeeded remove admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                wait["addadmin"] = True
                                aditmadzs.sendMessage(msg.to,"Send the contact...")
                            ...
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"Successfully Refreshed...")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"Notag activated")

                        elif cmd == "notag off" or text.lower() == 'notag off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentionkick"] = False
                                aditmadzs.sendMessage(msg.to,"Notag deactivated")

                        elif cmd == "contact on" or text.lower() == 'contact on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                aditmadzs.sendMessage(msg.to,"Detection contact activated")

                        elif cmd == "contact off" or text.lower() == 'contact off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                aditmadzs.sendMessage(msg.to,"Detection contact deactivated")

                        elif cmd == "respon on" or text.lower() == 'respon on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = True
                                aditmadzs.sendMessage(msg.to,"Auto respon activated")

                        elif cmd == "respon off" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                aditmadzs.sendMessage(msg.to,"Auto respon deactivated")

                        elif cmd == "respongift on" or text.lower() == 'respongift on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = True
                                aditmadzs.sendMessage(msg.to,"Auto respon gift activated")

                        elif cmd == "respongift off" or text.lower() == 'respongift off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = False
                                aditmadzs.sendMessage(msg.to,"Auto respon gift deactivated")

                        elif cmd == "autojoin on" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                aditmadzs.sendMessage(msg.to,"Autojoin activated")

                        elif cmd == "autojoin off" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                aditmadzs.sendMessage(msg.to,"Autojoin deactivated")

                        elif cmd == "autoleave on" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                aditmadzs.sendMessage(msg.to,"Auto Leave activated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                aditmadzs.sendMessage(msg.to,"Auto Add activated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                aditmadzs.sendMessage(msg.to,"Detect Sticker activated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                aditmadzs.sendMessage(msg.to,"Auto Join Ticket activated")
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           aditmadzs.sendMessage(msg.to,"Succeeded Add blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           aditmadzs.sendMessage(msg.to,"Succeeded remove blacklist")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                aditmadzs.sendMessage(msg.to,"Not ada blacklist")
                              else:
                                ma = ""
                                a = 0
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                aditmadzs.sendMessage(msg.to,"Not ada Talkban user")
                              else:
                                ma = ""
                                a = 0
